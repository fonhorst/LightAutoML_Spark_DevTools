...
COPY $SLAMA_BUILD_TMP/SparkLightAutoML_DEV-0.3.0-py3-none-any.whl /src/SparkLightAutoML-0.3.0-py3-none-any.whl
COPY $SLAMA_BUILD_TMP/spark-lightautoml_2.12-0.1.jar /src
